...
export class BookList {
   ...
   add = (book) => {
      if (!(book instanceof Book))
         throw new Error(
            "The attribute passed should be an instance of the Book Object"
         );
   ...
   finishBook = (book) => {
      ...
      if (bookIndex === -1)
         throw new Error("The book passed does not exist in the list");
   ...
   getPendingBooks = () =>
      this.bookList.filter((b) => b.getIsRead() == false).length;
}
